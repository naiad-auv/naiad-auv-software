...
--  id:2.1/275b32744794e8c7/i16Get_Temp_Int/1/0/
   ...
   --  temp_sensor.ads:27:4:i16Get_Temp_Int
--  end read only
   ...
   begin
      ...
      AUnit.Assertions.Assert
        (i16Get_Temp_Int(0) = 125 * 16, --125 degrees is a hard coded value
         "Returned temperature incorrect");
...
--  begin read only
   ...
   procedure Test_i16ToStr_64400a (Gnattest_T : in out Test) renames Test_i16ToStr;
--  id:2.1/64400a5a04ebce3d/i16ToStr/1/0/
   procedure Test_i16ToStr (Gnattest_T : in out Test) is
   --  temp_sensor.ads:29:4:i16ToStr
--  end read only
   ...
   begin
      ...
      str := i16ToStr(Interfaces.Integer_16(-8));
...
--  id:2.1/544d1c10bf80582f/i16From_Bytes/1/0/
   ...
   --  temp_sensor.ads:39:4:i16From_Bytes
--  end read only
...
--  id:2.1/4346324808f9f7d3/bReset_Pulse/1/0/
   ...
   --  temp_sensor.ads:44:4:bReset_Pulse
--  end read only
...
--  id:2.1/8045aa83b2d391ad/Write_Byte/1/0/
   ...
   --  temp_sensor.ads:46:4:Write_Byte
--  end read only
...
--  id:2.1/67fda566818501c2/u8Read_Byte/1/0/
   ...
   --  temp_sensor.ads:48:4:u8Read_Byte
--  end read only
