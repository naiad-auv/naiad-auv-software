...
package body Salinity_Sensor.Test_Data.Tests.Suite is
   ...
   Case_4_1_Test_Put_33f5c9 : aliased Runner_1.Test_Case;
   Case_5_1_Test_Write_1a5fb8 : aliased Runner_1.Test_Case;
   Case_6_1_Test_Get_Char_06e8ff : aliased Runner_1.Test_Case;
   Case_7_1_Test_Message_Received_39abee : aliased Runner_1.Test_Case;
   ...
   begin
      ...
      Result.Add_Test (Case_4_1_Test_Put_33f5c9'Access);
      Result.Add_Test (Case_5_1_Test_Write_1a5fb8'Access);
      Result.Add_Test (Case_6_1_Test_Get_Char_06e8ff'Access);
      Result.Add_Test (Case_7_1_Test_Message_Received_39abee'Access);
