...
package ada_main is
   ...
   u00196 : constant Version_32 := 16#e52f0411#;
   ...
   u00200 : constant Version_32 := 16#86048f24#;
   pragma Export (C, u00200, "avr__at90can128__calendarB");
   u00201 : constant Version_32 := 16#10309d59#;
   pragma Export (C, u00201, "avr__at90can128__calendarS");
   u00202 : constant Version_32 := 16#8c2aa244#;
   pragma Export (C, u00202, "avr__at90can128__calendar__test_dataB");
   u00203 : constant Version_32 := 16#dc6c8ffd#;
   pragma Export (C, u00203, "avr__at90can128__calendar__test_dataS");
   ...
   u00206 : constant Version_32 := 16#30e51d49#;
   pragma Export (C, u00206, "avr__at90can128__calendar__test_data__testsB");
   u00207 : constant Version_32 := 16#3b972441#;
   pragma Export (C, u00207, "avr__at90can128__calendar__test_data__testsS");
   u00208 : constant Version_32 := 16#d57593f4#;
   pragma Export (C, u00208, "avr__at90can128__calendar__test_data__tests__suiteB");
   u00209 : constant Version_32 := 16#f3f1fca8#;
   pragma Export (C, u00209, "avr__at90can128__calendar__test_data__tests__suiteS");
   ...
   u00212 : constant Version_32 := 16#5b55ca34#;
   pragma Export (C, u00212, "digital_ioB");
   u00213 : constant Version_32 := 16#b1f3be84#;
   pragma Export (C, u00213, "digital_ioS");
   u00214 : constant Version_32 := 16#b88cd3bc#;
   pragma Export (C, u00214, "digital_io__test_dataB");
   u00215 : constant Version_32 := 16#82a085c6#;
   pragma Export (C, u00215, "digital_io__test_dataS");
   u00216 : constant Version_32 := 16#b5ac9636#;
   pragma Export (C, u00216, "digital_io__test_data__testsB");
   u00217 : constant Version_32 := 16#2b0044df#;
   pragma Export (C, u00217, "digital_io__test_data__testsS");
   u00218 : constant Version_32 := 16#ae153ac2#;
   pragma Export (C, u00218, "digital_io__test_data__tests__suiteB");
   u00219 : constant Version_32 := 16#c7602069#;
   pragma Export (C, u00219, "digital_io__test_data__tests__suiteS");
   u00220 : constant Version_32 := 16#80bff625#;
   pragma Export (C, u00220, "temp_sensorB");
   u00221 : constant Version_32 := 16#c86ef3a2#;
   pragma Export (C, u00221, "temp_sensorS");
   u00222 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00222, "system__concat_4B");
   u00223 : constant Version_32 := 16#5d974de8#;
   pragma Export (C, u00223, "system__concat_4S");
   u00224 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00224, "system__concat_3B");
   u00225 : constant Version_32 := 16#29e2ac3c#;
   pragma Export (C, u00225, "system__concat_3S");
   u00226 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00226, "system__concat_2B");
   u00227 : constant Version_32 := 16#a4185caa#;
   pragma Export (C, u00227, "system__concat_2S");
   u00228 : constant Version_32 := 16#698aef6f#;
   pragma Export (C, u00228, "temp_sensor__test_dataB");
   u00229 : constant Version_32 := 16#1fd65775#;
   pragma Export (C, u00229, "temp_sensor__test_dataS");
   u00230 : constant Version_32 := 16#0088ce38#;
   pragma Export (C, u00230, "temp_sensor__test_data__testsB");
   u00231 : constant Version_32 := 16#9657a9df#;
   pragma Export (C, u00231, "temp_sensor__test_data__testsS");
   u00232 : constant Version_32 := 16#2c529dc0#;
   pragma Export (C, u00232, "temp_sensor__test_data__tests__suiteB");
   u00233 : constant Version_32 := 16#1125591e#;
   pragma Export (C, u00233, "temp_sensor__test_data__tests__suiteS");
   ...
   --  digital_io.test_data.tests.suite%b
   ...
   --  temp_sensor.test_data.tests%b
   --  temp_sensor.test_data.tests.suite%s
   --  temp_sensor.test_data.tests.suite%b
