...
--  begin read only
   ...
   procedure Test_pxCreate_a90dd2 (Gnattest_T : in out Test) renames Test_1_pxCreate;
--  id:2.1/a90dd20a6e115ee9/pxCreate/1/0/
   procedure Test_1_pxCreate (Gnattest_T : in out Test) is
   --  math-quaternions.ads:17:4:pxCreate
--  end read only
...
--  id:2.1/937a5186dd726f3b/pxCreate/0/0/
   ...
   --  math-quaternions.ads:18:4:pxCreate
--  end read only
...
--  begin read only
   procedure Test_3_pxCreate (Gnattest_T : in out Test);
   procedure Test_pxCreate_944041 (Gnattest_T : in out Test) renames Test_3_pxCreate;
--  id:2.1/94404173a2d126d0/pxCreate/0/0/
   procedure Test_3_pxCreate (Gnattest_T : in out Test) is
   --  math-quaternions.ads:91:4:pxCreate
--  end read only
