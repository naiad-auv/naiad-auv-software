...
package Math.Vectors.CVector_Test_Data.CVector_Tests is

   type Test_CVector is new
   ...
   procedure Test_Copy_From_535aa7 (Gnattest_T : in out Test_CVector);
   --  math-vectors.ads:38:4:Copy_From

   procedure Test_Devide_7a37a3 (Gnattest_T : in out Test_CVector);
   --  math-vectors.ads:49:4:Devide
