...
package body ada_main is
   ...
   E208 : Short_Integer; pragma Import (Ada, E208, "aunit__test_caller_E");
   ...
   E198 : Short_Integer; pragma Import (Ada, E198, "navigation__pid_controller_E");
   E196 : Short_Integer; pragma Import (Ada, E196, "navigation__motion_axis_E");
   E200 : Short_Integer; pragma Import (Ada, E200, "navigation__motion_axis__cmotion_axis_test_data_E");
   E204 : Short_Integer; pragma Import (Ada, E204, "navigation__motion_axis__cmotion_axis_test_data__cmotion_axis_tests_E");
   E206 : Short_Integer; pragma Import (Ada, E206, "navigation__motion_axis__cmotion_axis_test_data__cmotion_axis_tests__suite_E");
   E210 : Short_Integer; pragma Import (Ada, E210, "navigation__motion_axis__test_data_E");
   E212 : Short_Integer; pragma Import (Ada, E212, "navigation__motion_axis__test_data__tests_E");
   E214 : Short_Integer; pragma Import (Ada, E214, "navigation__motion_axis__test_data__tests__suite_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "navigation__motion_axis__test_data__tests__suite__finalize_body");
      begin
         E214 := E214 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "navigation__motion_axis__test_data__tests__finalize_spec");
      begin
         F2;
      end;
      E210 := E210 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "navigation__motion_axis__test_data__finalize_spec");
      begin
         F3;
      end;
      declare
         procedure F4;
         pragma Import (Ada, F4, "navigation__motion_axis__cmotion_axis_test_data__cmotion_axis_tests__suite__finalize_body");
      begin
         E206 := E206 - 1;
         F4;
      end;
      ...
      declare
         procedure F5;
         pragma Import (Ada, F5, "navigation__motion_axis__cmotion_axis_test_data__cmotion_axis_tests__finalize_spec");
      begin
         F5;
      end;
      E200 := E200 - 1;
      declare
         procedure F6;
         pragma Import (Ada, F6, "navigation__motion_axis__cmotion_axis_test_data__finalize_spec");
      begin
         F6;
      end;
      E196 := E196 - 1;
      declare
         procedure F7;
         pragma Import (Ada, F7, "navigation__motion_axis__finalize_spec");
      begin
         F7;
      end;
      E198 := E198 - 1;
      declare
         procedure F8;
         pragma Import (Ada, F8, "navigation__pid_controller__finalize_spec");
      begin
         F8;
      end;
      E083 := E083 - 1;
      ...
      declare
         procedure F12;
         pragma Import (Ada, F12, "aunit__reporter__gnattest__finalize_spec");
      begin
         F12;
      end;
      E090 := E090 - 1;
      ...
      declare
         procedure F15;
         pragma Import (Ada, F15, "aunit__test_filters__finalize_spec");
      begin
         F15;
      end;
      declare
      ...
      declare
         procedure F20;
         pragma Import (Ada, F20, "system__object_reader__finalize_body");
      begin
         E142 := E142 - 1;
         F20;
      end;
      ...
      declare
         procedure F22;
         pragma Import (Ada, F22, "system__object_reader__finalize_spec");
      begin
         F22;
      end;
      declare
   ...
   begin
      ...
      E198 := E198 + 1;
      Navigation.Motion_Axis'Elab_Spec;
      E196 := E196 + 1;
      Navigation.Motion_Axis.Cmotion_Axis_Test_Data'Elab_Spec;
      Navigation.Motion_Axis.Cmotion_Axis_Test_Data'Elab_Body;
      E200 := E200 + 1;
      Navigation.Motion_Axis.Cmotion_Axis_Test_Data.Cmotion_Axis_Tests'Elab_Spec;
      E204 := E204 + 1;
      Navigation.Motion_Axis.Cmotion_Axis_Test_Data.Cmotion_Axis_Tests.Suite'Elab_Body;
      E206 := E206 + 1;
      Navigation.Motion_Axis.Test_Data'Elab_Spec;
      E210 := E210 + 1;
      Navigation.Motion_Axis.Test_Data.Tests'Elab_Spec;
      E212 := E212 + 1;
      Navigation.Motion_Axis.Test_Data.Tests.Suite'Elab_Body;
      E214 := E214 + 1;
...
--  BEGIN Object file/option list
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/gnattest_generated.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/test_runner.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/obj/navigation.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/pid_controller/obj/navigation-pid_controller.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/navigation-motion_axis.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-cmotion_axis_test_data.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-cmotion_axis_test_data-cmotion_axis_tests.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-cmotion_axis_test_data-cmotion_axis_tests-suite.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-test_data.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-test_data-tests.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/navigation-motion_axis-test_data-tests-suite.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/gnattest_main_suite.o
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/gnattest/harness/
   --   -L/usr/gnat/lib/aunit/native-full/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/motion_axis/obj/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/pid_controller/obj/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/obj/
