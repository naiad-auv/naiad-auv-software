...
package body Navigation.Thruster_Configurator.Test_Data.Tests.Suite is
   ...
   Case_1_1_Test_pxCreate_c3cf4c : aliased Runner_1.Test_Case;

   function Suite return AUnit.Test_Suites.Access_Test_Suite is
   begin

      Runner_1.Create
        (Case_1_1_Test_pxCreate_c3cf4c,
         "navigation-thruster_configurator.ads:19:4:",
         Test_pxCreate_c3cf4c'Access);

      Result.Add_Test (Case_1_1_Test_pxCreate_c3cf4c'Access);
