...
private
   ...
   function fGet_Current_Directional_Component(this : in COrientational_Controller) return float;
   function fGet_Wanted_Directional_Component(this : in COrientational_Controller) return float;
