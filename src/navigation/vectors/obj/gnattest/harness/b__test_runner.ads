...
package ada_main is
   ...
   u00191 : constant Version_32 := 16#cb74a5dc#;
   ...
   u00202 : constant Version_32 := 16#4f1f4f21#;
   pragma Export (C, u00202, "system__fat_llfS");
   u00203 : constant Version_32 := 16#9f9feadf#;
   pragma Export (C, u00203, "system__machine_codeS");
   u00204 : constant Version_32 := 16#0be1b996#;
   pragma Export (C, u00204, "system__exn_llfB");
   u00205 : constant Version_32 := 16#11a08ffe#;
   pragma Export (C, u00205, "system__exn_llfS");
   u00206 : constant Version_32 := 16#13fde8c6#;
   pragma Export (C, u00206, "system__fat_fltS");
   u00207 : constant Version_32 := 16#bdd35e15#;
   pragma Export (C, u00207, "navigation__vectors__cvector_test_dataB");
   u00208 : constant Version_32 := 16#00ed7d9f#;
   pragma Export (C, u00208, "navigation__vectors__cvector_test_dataS");
   u00209 : constant Version_32 := 16#269b1972#;
   pragma Export (C, u00209, "aunit__test_fixturesB");
   u00210 : constant Version_32 := 16#3b99f1a5#;
   pragma Export (C, u00210, "aunit__test_fixturesS");
   u00211 : constant Version_32 := 16#f7413cbe#;
   pragma Export (C, u00211, "navigation__vectors__cvector_test_data__cvector_testsB");
   u00212 : constant Version_32 := 16#6f204937#;
   pragma Export (C, u00212, "navigation__vectors__cvector_test_data__cvector_testsS");
   u00213 : constant Version_32 := 16#6d0081c3#;
   ...
   u00216 : constant Version_32 := 16#70d8d22d#;
   pragma Export (C, u00216, "system__float_controlS");
   u00217 : constant Version_32 := 16#06417083#;
   pragma Export (C, u00217, "system__img_lluB");
   u00218 : constant Version_32 := 16#b30ccda4#;
   pragma Export (C, u00218, "system__img_lluS");
   u00219 : constant Version_32 := 16#c054f766#;
   pragma Export (C, u00219, "system__powten_tableS");
   u00220 : constant Version_32 := 16#635fca88#;
   pragma Export (C, u00220, "navigation__vectors__cvector_test_data__cvector_tests__suiteB");
   u00221 : constant Version_32 := 16#da626991#;
   pragma Export (C, u00221, "navigation__vectors__cvector_test_data__cvector_tests__suiteS");
   u00222 : constant Version_32 := 16#8f189ee8#;
   pragma Export (C, u00222, "aunit__test_callerB");
   u00223 : constant Version_32 := 16#581d22b8#;
   pragma Export (C, u00223, "aunit__test_callerS");
   u00224 : constant Version_32 := 16#f827498e#;
   pragma Export (C, u00224, "navigation__vectors__test_dataB");
   u00225 : constant Version_32 := 16#dfb478ab#;
   pragma Export (C, u00225, "navigation__vectors__test_dataS");
   u00226 : constant Version_32 := 16#b28a934e#;
   pragma Export (C, u00226, "navigation__vectors__test_data__testsB");
   u00227 : constant Version_32 := 16#cfd370e9#;
   pragma Export (C, u00227, "navigation__vectors__test_data__testsS");
   u00228 : constant Version_32 := 16#4c8195e5#;
   pragma Export (C, u00228, "navigation__vectors__test_data__tests__suiteB");
   u00229 : constant Version_32 := 16#3b782d1b#;
   pragma Export (C, u00229, "navigation__vectors__test_data__tests__suiteS");
   ...
   --  navigation.vectors.cvector_test_data%s
   --  navigation.vectors.cvector_test_data%b
   --  navigation.vectors.cvector_test_data.cvector_tests%s
   --  navigation.vectors.cvector_test_data.cvector_tests%b
   --  navigation.vectors.cvector_test_data.cvector_tests.suite%s
   --  navigation.vectors.cvector_test_data.cvector_tests.suite%b
