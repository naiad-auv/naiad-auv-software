...
package body ada_main is
   ...
   E206 : Short_Integer; pragma Import (Ada, E206, "system__fat_flt_E");
   E202 : Short_Integer; pragma Import (Ada, E202, "system__fat_llf_E");
   ...
   E197 : Short_Integer; pragma Import (Ada, E197, "ada__numerics_E");
   ...
   E210 : Short_Integer; pragma Import (Ada, E210, "aunit__test_fixtures_E");
   E223 : Short_Integer; pragma Import (Ada, E223, "aunit__test_caller_E");
   ...
   E196 : Short_Integer; pragma Import (Ada, E196, "navigation__vectors_E");
   E208 : Short_Integer; pragma Import (Ada, E208, "navigation__vectors__cvector_test_data_E");
   E212 : Short_Integer; pragma Import (Ada, E212, "navigation__vectors__cvector_test_data__cvector_tests_E");
   E221 : Short_Integer; pragma Import (Ada, E221, "navigation__vectors__cvector_test_data__cvector_tests__suite_E");
   E225 : Short_Integer; pragma Import (Ada, E225, "navigation__vectors__test_data_E");
   E227 : Short_Integer; pragma Import (Ada, E227, "navigation__vectors__test_data__tests_E");
   E229 : Short_Integer; pragma Import (Ada, E229, "navigation__vectors__test_data__tests__suite_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "navigation__vectors__test_data__tests__suite__finalize_body");
      begin
         E229 := E229 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "navigation__vectors__test_data__tests__finalize_spec");
      begin
         F2;
      end;
      E225 := E225 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "navigation__vectors__test_data__finalize_spec");
      begin
         F3;
      end;
      declare
         procedure F4;
         pragma Import (Ada, F4, "navigation__vectors__cvector_test_data__cvector_tests__suite__finalize_body");
      begin
         E221 := E221 - 1;
         F4;
      end;
      ...
      declare
         procedure F5;
         pragma Import (Ada, F5, "navigation__vectors__cvector_test_data__cvector_tests__finalize_spec");
      begin
         F5;
      end;
      E208 := E208 - 1;
      declare
         procedure F6;
         pragma Import (Ada, F6, "navigation__vectors__cvector_test_data__finalize_spec");
      begin
         F6;
      end;
      E196 := E196 - 1;
      declare
         procedure F7;
         pragma Import (Ada, F7, "navigation__vectors__finalize_spec");
      begin
         F7;
      end;
      E083 := E083 - 1;
   ...
   begin
      ...
      E081 := E081 + 1;
      E194 := E194 + 1;
      Navigation.Vectors'Elab_Spec;
      E196 := E196 + 1;
      Navigation.Vectors.Cvector_Test_Data'Elab_Spec;
      Navigation.Vectors.Cvector_Test_Data'Elab_Body;
      E208 := E208 + 1;
      Navigation.Vectors.Cvector_Test_Data.Cvector_Tests'Elab_Spec;
      E212 := E212 + 1;
      Navigation.Vectors.Cvector_Test_Data.Cvector_Tests.Suite'Elab_Body;
      E221 := E221 + 1;
      Navigation.Vectors.Test_Data'Elab_Spec;
      E225 := E225 + 1;
      Navigation.Vectors.Test_Data.Tests'Elab_Spec;
      E227 := E227 + 1;
      Navigation.Vectors.Test_Data.Tests.Suite'Elab_Body;
      E229 := E229 + 1;
...
--  BEGIN Object file/option list
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/gnattest_generated.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/test_runner.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/obj/navigation.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/navigation-vectors.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-cvector_test_data.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-cvector_test_data-cvector_tests.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-cvector_test_data-cvector_tests-suite.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-test_data.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-test_data-tests.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/navigation-vectors-test_data-tests-suite.o
   --   /home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/gnattest_main_suite.o
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/gnattest/harness/
   --   -L/usr/gnat/lib/aunit/native-full/
   --   -L/home/emibe/skola/robgit/naiad-auv-software/src/navigation/vectors/obj/
