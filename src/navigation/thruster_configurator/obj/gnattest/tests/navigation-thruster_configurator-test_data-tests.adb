...
--  begin read only
   ...
   procedure Test_pxCreate_c3cf4c (Gnattest_T : in out Test) renames Test_pxCreate;
--  id:2.1/c3cf4c53e4865d6f/pxCreate/1/0/
   procedure Test_pxCreate (Gnattest_T : in out Test) is
   --  navigation-thruster_configurator.ads:19:4:pxCreate
--  end read only
