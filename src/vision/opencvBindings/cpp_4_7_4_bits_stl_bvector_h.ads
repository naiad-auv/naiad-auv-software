...
package cpp_4_7_4_bits_stl_bvector_h is
   ...
   package Class_u_Bit_reference is
      ...
      function operator_13 (this : access constant u_Bit_reference) return Extensions.bool;  -- /usr/gnat/lib/gcc/x86_64-pc-linux-gnu/4.7.4/../../../../include/c++/4.7.4/bits/stl_bvector.h:81
      pragma Import (CPP, operator_13, "_ZNKSt14_Bit_referencecvbEv");
