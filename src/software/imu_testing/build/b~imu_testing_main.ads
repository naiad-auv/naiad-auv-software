...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_imu_testing_main" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c7cb2490#;
   pragma Export (C, u00001, "imu_testing_mainB");
   ...
   u00055 : constant Version_32 := 16#421d3150#;
   pragma Export (C, u00055, "ada__text_ioB");
   u00056 : constant Version_32 := 16#dac0d159#;
   ...
   u00059 : constant Version_32 := 16#39106b41#;
   pragma Export (C, u00059, "ada__tagsS");
   u00060 : constant Version_32 := 16#fac5cd67#;
   pragma Export (C, u00060, "system__unsigned_typesS");
   u00061 : constant Version_32 := 16#25c21d28#;
   pragma Export (C, u00061, "system__val_lluB");
   u00062 : constant Version_32 := 16#80379a15#;
   pragma Export (C, u00062, "system__val_lluS");
   u00063 : constant Version_32 := 16#aea309ed#;
   pragma Export (C, u00063, "system__val_utilB");
   u00064 : constant Version_32 := 16#3c8427ef#;
   pragma Export (C, u00064, "system__val_utilS");
   u00065 : constant Version_32 := 16#b7fa72e7#;
   pragma Export (C, u00065, "system__case_utilB");
   u00066 : constant Version_32 := 16#3d38f199#;
   ...
   u00075 : constant Version_32 := 16#dfd6e281#;
   ...
   u00077 : constant Version_32 := 16#9f990c8b#;
   ...
   u00090 : constant Version_32 := 16#31c80c2b#;
   ...
   u00099 : constant Version_32 := 16#fc605663#;
   pragma Export (C, u00099, "system__memoryB");
   u00100 : constant Version_32 := 16#5aaf2d04#;
   pragma Export (C, u00100, "system__memoryS");
   u00101 : constant Version_32 := 16#1fd820b1#;
   pragma Export (C, u00101, "system__storage_pools__subpoolsB");
   u00102 : constant Version_32 := 16#951e0de9#;
   pragma Export (C, u00102, "system__storage_pools__subpoolsS");
   u00103 : constant Version_32 := 16#1777d351#;
   pragma Export (C, u00103, "system__storage_pools__subpools__finalizationB");
   u00104 : constant Version_32 := 16#12aaf1de#;
   pragma Export (C, u00104, "system__storage_pools__subpools__finalizationS");
   u00105 : constant Version_32 := 16#393f5eee#;
   pragma Export (C, u00105, "ins_controller_utilsB");
   u00106 : constant Version_32 := 16#23c4b3ce#;
   pragma Export (C, u00106, "ins_controller_utilsS");
   u00107 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00107, "system__concat_2B");
   u00108 : constant Version_32 := 16#6bf463ed#;
   pragma Export (C, u00108, "system__concat_2S");
   u00109 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00109, "system__concat_3B");
   u00110 : constant Version_32 := 16#e60e937b#;
   pragma Export (C, u00110, "system__concat_3S");
   u00111 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00111, "system__concat_4B");
   u00112 : constant Version_32 := 16#927b72af#;
   ...
   u00116 : constant Version_32 := 16#eb9778d0#;
   ...
   u00118 : constant Version_32 := 16#3ff16a6d#;
   pragma Export (C, u00118, "gnat__os_libS");
   u00119 : constant Version_32 := 16#5de653db#;
   pragma Export (C, u00119, "system__communicationB");
   u00120 : constant Version_32 := 16#650fb457#;
   pragma Export (C, u00120, "system__communicationS");
   u00121 : constant Version_32 := 16#60238118#;
   pragma Export (C, u00121, "system__os_constantsS");
   u00122 : constant Version_32 := 16#9946868c#;
   pragma Export (C, u00122, "str2floatB");
   u00123 : constant Version_32 := 16#fb4f6c6e#;
   pragma Export (C, u00123, "str2floatS");
   u00124 : constant Version_32 := 16#c9fdc962#;
   pragma Export (C, u00124, "system__concat_6B");
   u00125 : constant Version_32 := 16#57ee6405#;
   pragma Export (C, u00125, "system__concat_6S");
   u00126 : constant Version_32 := 16#def1dd00#;
   pragma Export (C, u00126, "system__concat_5B");
   u00127 : constant Version_32 := 16#801d5fb0#;
   pragma Export (C, u00127, "system__concat_5S");
   u00128 : constant Version_32 := 16#6d0081c3#;
   pragma Export (C, u00128, "system__img_realB");
   u00129 : constant Version_32 := 16#578cc0f3#;
   pragma Export (C, u00129, "system__img_realS");
   u00130 : constant Version_32 := 16#4f1f4f21#;
   ...
   u00132 : constant Version_32 := 16#70d8d22d#;
   pragma Export (C, u00132, "system__float_controlS");
   u00133 : constant Version_32 := 16#06417083#;
   pragma Export (C, u00133, "system__img_lluB");
   u00134 : constant Version_32 := 16#b30ccda4#;
   pragma Export (C, u00134, "system__img_lluS");
   u00135 : constant Version_32 := 16#194ccd7b#;
   pragma Export (C, u00135, "system__img_unsB");
   u00136 : constant Version_32 := 16#6531f190#;
   pragma Export (C, u00136, "system__img_unsS");
   u00137 : constant Version_32 := 16#c054f766#;
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  ins_controller_utils%s
   --  str2float%s
   --  str2float%b
   --  imu_testing_main%b
   --  uartwrapper%s
   --  uartwrapper%b
   --  ins_controller_utils%b
