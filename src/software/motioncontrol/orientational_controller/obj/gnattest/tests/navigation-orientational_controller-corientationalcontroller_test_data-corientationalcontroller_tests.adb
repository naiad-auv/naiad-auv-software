...
--  begin read only
   procedure Test_Get_Orientational_Thruster_Control_Values (Gnattest_T : in out Test_COrientationalController);
   procedure Test_Get_Orientational_Thruster_Control_Values_6c2c02 (Gnattest_T : in out Test_COrientationalController) renames Test_Get_Orientational_Thruster_Control_Values;
--  id:2.1/6c2c02168ce61f0b/Get_Orientational_Thruster_Control_Values/1/0/
   procedure Test_Get_Orientational_Thruster_Control_Values (Gnattest_T : in out Test_COrientationalController) is
   --  navigation-orientational_controller.ads:36:4:Get_Orientational_Thruster_Control_Values
--  end read only
   ...
   begin
      ...
      pxOrientationalController.Get_Orientational_Thruster_Control_Values(fDeltaTime => 1.0,
                                                                          tfValues   => xThrusterControlValues);
...
--  begin read only
   end Test_Get_Orientational_Thruster_Control_Values;
--  end read only
...
--  id:2.1/a4d64d73d258bef8/Update_Current_Errors/1/0/
   ...
   --  navigation-orientational_controller.ads:42:4:Update_Current_Errors
--  end read only
      ...
      tfErrors : Navigation.Orientational_Controller.TOrientationalErrors;
      pxOrientationalController : Navigation.Orientational_Controller.pCOrientationalController;
...
--                                                                                                                     fAngleInDegrees => 90.0))).pxGet_Allocated_Copy;
      pxWantedOrientation : Math.Matrices.pCMatrix := Math.Matrices.xCreate_Rotation_Around_X_Axis(tfAngleInDegrees => 90.0).pxGet_Allocated_Copy;
   ...
   begin
      ...
      tfErrors := pxOrientationalController.fGetCurrentErrors;
--        AUnit.Assertions.Assert(Condition => False,
--                                Message   => "Errors: " & tfErrors(Navigation.Motion_Component.RotationX)'Img & " " & tfErrors(Navigation.Motion_Component.RotationY)'Img & " " & tfErrors(Navigation.Motion_Component.RotationZ)'Img);
...
--  id:2.1/f2c0ab1f654d5493/Set_New_PID_Component_Scalings/1/0/
   ...
   --  navigation-orientational_controller.ads:46:4:Set_New_PID_Component_Scalings
--  end read only
...
--  begin read only
   procedure Test_fGetCurrentErrors (Gnattest_T : in out Test_COrientationalController);
   procedure Test_fGetCurrentErrors_4d9c3d (Gnattest_T : in out Test_COrientationalController) renames Test_fGetCurrentErrors;
--  id:2.1/4d9c3dc6e4ff8794/fGetCurrentErrors/1/0/
   procedure Test_fGetCurrentErrors (Gnattest_T : in out Test_COrientationalController) is
   --  navigation-orientational_controller.ads:53:4:fGetCurrentErrors
--  end read only
...
--  id:2.1/80be144c44fd4f0e/Update_Current_X_Rotation_Error/1/0/
   ...
   --  navigation-orientational_controller.ads:57:4:Update_Current_X_Rotation_Error
--  end read only
...
--  id:2.1/02960d66e2acc2ab/Update_Current_Y_Rotation_Error/1/0/
   ...
   --  navigation-orientational_controller.ads:58:4:Update_Current_Y_Rotation_Error
--  end read only
...
--  id:2.1/6e9d1b848fcdb811/Update_Current_Z_Rotation_Error/1/0/
   ...
   --  navigation-orientational_controller.ads:59:4:Update_Current_Z_Rotation_Error
--  end read only
...
--  id:2.1/425dcecd2fee317b/xGet_X_Rotation_Thruster_Control_Value/1/0/
   ...
   --  navigation-orientational_controller.ads:61:4:xGet_X_Rotation_Thruster_Control_Value
--  end read only
...
--  id:2.1/beea5c7271735076/xGet_Y_Rotation_Thruster_Control_Value/1/0/
   ...
   --  navigation-orientational_controller.ads:62:4:xGet_Y_Rotation_Thruster_Control_Value
--  end read only
...
--  id:2.1/bdcbeff12393ea63/xGet_Z_Rotation_Thruster_Control_Value/1/0/
   ...
   --  navigation-orientational_controller.ads:63:4:xGet_Z_Rotation_Thruster_Control_Value
--  end read only
...
--  id:2.1/1d29f15228a8f8f4/Finalize/1/0/
   ...
   --  navigation-orientational_controller.ads:86:4:Finalize
--  end read only
...
--  id:2.1/ec7316121441667a/xGet_Orientational_Thruster_Control_Values/0/1/
