...
package MotionControl.Motion_Component is
   ...
   function pxCreate (eAxisIndex : EMotionComponent; xPIDScalings : MotionControl.PID_Controller.TPIDComponentScalings) return pCMotionComponent;
...
--  <parameter name="eAxisIndex">The index of the axis.</parameter>
   ...
   procedure Set_New_PID_Component_Scalings(this : in CMotionComponent; xNewScalings : MotionControl.PID_Controller.TPIDComponentScalings);
...
private
   ...
   type CMotionComponent is new Ada.Finalization.Controlled with
      record
         ...
         pxComponentPIDController : MotionControl.PID_Controller.pCPIDController;
      end record;
