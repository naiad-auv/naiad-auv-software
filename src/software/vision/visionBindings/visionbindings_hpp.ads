...
package visionBindings_hpp is
   ...
   package Class_Core_Wrap is
      ...
      procedure push_back (this : access Core_Wrap; src : Interfaces.C.Strings.chars_ptr);  -- visionBindings.cpp:61
      pragma Import (CPP, push_back, "_ZN9Core_Wrap9push_backEPc");

      procedure imread (this : access Core_Wrap; name : Interfaces.C.Strings.chars_ptr);  -- visionBindings.cpp:66
      pragma Import (CPP, imread, "_ZN9Core_Wrap6imreadEPc");

      function imwrite
        (this : access Core_Wrap;
         name : Interfaces.C.Strings.chars_ptr;
         src : int) return int;  -- visionBindings.cpp:71
      pragma Import (CPP, imwrite, "_ZN9Core_Wrap7imwriteEPci");

      procedure imshow
        (this : access Core_Wrap;
         name : Interfaces.C.Strings.chars_ptr;
         src : int);  -- visionBindings.cpp:79
      pragma Import (CPP, imshow, "_ZN9Core_Wrap6imshowEPci");

      procedure waitKey (this : access Core_Wrap; time : int);  -- visionBindings.cpp:84
      pragma Import (CPP, waitKey, "_ZN9Core_Wrap7waitKeyEi");

      function size (this : access Core_Wrap) return int;  -- visionBindings.cpp:89
      pragma Import (CPP, size, "_ZN9Core_Wrap4sizeEv");

      procedure test_func (this : access Core_Wrap);  -- visionBindings.cpp:27
      pragma Import (CPP, test_func, "_ZN9Core_Wrap9test_funcEv");

      function New_Core_Wrap return Core_Wrap;  -- visionBindings.cpp:94
   ...
   package Class_Processing_Wrap is
      ...
      procedure cvtColor
        (this : access Processing_Wrap;
         src : int;
         dst : int;
         filter : int);  -- visionBindings.cpp:98
      ...
      procedure Canny
        (this : access Processing_Wrap;
         ...
         lThresh : int;
         hThresh : int;
         kernelSize : int);  -- visionBindings.cpp:104
      ...
      procedure HoughCircles
        (this : access Processing_Wrap;
         ...
         minRadius : int;
         maxRadius : int);  -- visionBindings.cpp:111
      pragma Import (CPP, HoughCircles, "_ZN15Processing_Wrap12HoughCirclesEiiiiiii");

      procedure DrawHoughCircles (this : access Processing_Wrap; src : int);  -- visionBindings.cpp:125
      ...
      procedure HoughLines
        (this : access Processing_Wrap;
         ...
         rho : int;
         theta : float;
         intersectionThreshold : int);  -- visionBindings.cpp:171
      pragma Import (CPP, HoughLines, "_ZN15Processing_Wrap10HoughLinesEiifi");

      procedure DrawHoughLines (this : access Processing_Wrap; cdst : int);  -- visionBindings.cpp:182
      pragma Import (CPP, DrawHoughLines, "_ZN15Processing_Wrap14DrawHoughLinesEi");

      procedure Contours (this : access Processing_Wrap; src : int);  -- visionBindings.cpp:207
      ...
      procedure showContours
        (this : access Processing_Wrap;
         contourOut : int;
         contourId : int;
         thickness : int);  -- visionBindings.cpp:237
      pragma Import (CPP, showContours, "_ZN15Processing_Wrap12showContoursEiii");

      procedure approxPolyDP
        (this : access Processing_Wrap;
         epsilon : double;
         closed : Extensions.bool);  -- visionBindings.cpp:246
      pragma Import (CPP, approxPolyDP, "_ZN15Processing_Wrap12approxPolyDPEdb");

      procedure splitChannels (this : access Processing_Wrap; src : int);  -- visionBindings.cpp:283
      pragma Import (CPP, splitChannels, "_ZN15Processing_Wrap13splitChannelsEi");

      procedure showBlueChannel (this : access Processing_Wrap);  -- visionBindings.cpp:291
      pragma Import (CPP, showBlueChannel, "_ZN15Processing_Wrap15showBlueChannelEv");

      procedure showGreenChannel (this : access Processing_Wrap);  -- visionBindings.cpp:295
      pragma Import (CPP, showGreenChannel, "_ZN15Processing_Wrap16showGreenChannelEv");

      procedure showRedChannel (this : access Processing_Wrap);  -- visionBindings.cpp:299
      pragma Import (CPP, showRedChannel, "_ZN15Processing_Wrap14showRedChannelEv");

      function thresh
        (this : access Processing_Wrap;
         src : int;
         ch : int) return int;  -- visionBindings.cpp:306
      pragma Import (CPP, thresh, "_ZN15Processing_Wrap6threshEii");

      procedure LabelPoints (this : access Processing_Wrap; src : int);  -- visionBindings.cpp:145
      pragma Import (CPP, LabelPoints, "_ZN15Processing_Wrap11LabelPointsEi");

      function New_Processing_Wrap return Processing_Wrap;  -- visionBindings.cpp:350
   ...
   package Class_Preprocessing_Wrap is
      ...
      procedure VideoCaptureOpen (this : access Preprocessing_Wrap);  -- visionBindings.cpp:353
      ...
      procedure namedWindow
        (this : access Preprocessing_Wrap;
         name : Interfaces.C.Strings.chars_ptr;
         num : int);  -- visionBindings.cpp:358
      pragma Import (CPP, namedWindow, "_ZN18Preprocessing_Wrap11namedWindowEPci");

      procedure nextFrame (this : access Preprocessing_Wrap; dst : int);  -- visionBindings.cpp:363
      pragma Import (CPP, nextFrame, "_ZN18Preprocessing_Wrap9nextFrameEi");

      function New_Preprocessing_Wrap return Preprocessing_Wrap;  -- visionBindings.cpp:368
