...
*
* Modified by Debajyoti Nag and Gerard Duff sometime before you began reading this
*
*/
...
printf("rectify this \n");
  ...
  { //std::cout << " Usage: ./SURF_descriptor <img1> <img2>" << std::endl; 	
     ...
     //reprojectImageTo3D
     //Mat testReproject;
     printf("\n lets reproject this mother");
    //reprojectImageTo3D(disp8, testReproject, Q, true, -1 );
    //imshow("why so 3D?",testReproject);
