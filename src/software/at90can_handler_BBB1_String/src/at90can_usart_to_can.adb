...
--           AVR.AT90CAN128.PORTE.Bit_4 := true;
   ...
   begin
      ...
      for i in 0 .. 3 loop
         AVR.AT90CAN128.CAN.Can_Set_MOB_ID_MASK(AVR.AT90CAN128.CAN.BUFFER_ID(i), CAN_Defs.MSG_IMU_ORIENTATION_ID, CAN_Defs.MSG_IMU_ORIENTATION_ID);
         AVR.AT90CAN128.CAN.Can_Set_MOB_ID_MASK(AVR.AT90CAN128.CAN.BUFFER_ID(4 + (i mod 3)), CAN_Defs.MSG_IMU_ACCELERATION_ID, CAN_Defs.MSG_IMU_ACCELERATION_ID);
         AVR.AT90CAN128.CAN.Can_Set_MOB_ID_MASK(AVR.AT90CAN128.CAN.BUFFER_ID(7 + (i mod 3)), CAN_Defs.MSG_STRING_ID, CAN_Defs.MSG_STRING_ID);
      end loop;
