...
--        end loop;
   ...
   begin
      ...
      AVR.AT90CAN128.CAN.Can_Init(Can_Defs.K250, Board_and_Mode_Defs.BBB_CONTROLLER_2 );
...
--        end loop;
      AVR.AT90CAN128.CAN.Can_Set_All_MOB_ID_MASK(CAN_Defs.MSG_GYRO_YAW_ID,
                                                CAN_Defs.MSG_GYRO_YAW_ID);
   end Hardware_Init;
