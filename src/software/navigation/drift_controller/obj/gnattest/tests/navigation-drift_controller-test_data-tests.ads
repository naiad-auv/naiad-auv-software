...
package Navigation.Drift_Controller.Test_Data.Tests is

   type Test is new GNATtest_Generated.GNATtest_Standard.Navigation.Drift_Controller.Test_Data.Test
   with null record;
