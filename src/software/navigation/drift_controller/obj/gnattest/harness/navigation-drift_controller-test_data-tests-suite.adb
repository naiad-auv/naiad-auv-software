...
package body Navigation.Drift_Controller.Test_Data.Tests.Suite is
   ...
   Case_2_1_Test_pxCreate_3be9de : aliased Runner_1.Test_Case;
   ...
   begin
      ...
      Runner_1.Create
        (Case_2_1_Test_pxCreate_3be9de,
         "navigation-drift_controller.ads:17:4:",
         Test_pxCreate_3be9de'Access);

      Result.Add_Test (Case_1_1_Test_Free_e78edb'Access);
      Result.Add_Test (Case_2_1_Test_pxCreate_3be9de'Access);
