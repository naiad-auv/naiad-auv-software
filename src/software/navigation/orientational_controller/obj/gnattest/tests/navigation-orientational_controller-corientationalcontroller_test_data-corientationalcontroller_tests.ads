...
package Navigation.Orientational_Controller.COrientationalController_Test_Data.COrientationalController_Tests is
   ...
   procedure Test_Get_Orientational_Thruster_Control_Values_6c2c02 (Gnattest_T : in out Test_COrientationalController);
   ...
   procedure Test_fGetCurrentErrors_4d9c3d (Gnattest_T : in out Test_COrientationalController);
