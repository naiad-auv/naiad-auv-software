...
package Navigation.Dispatcher is
   ...
   type TMotionalErrors is array (Navigation.Motion_Component.PositionX .. Navigation.Motion_Component.RotationZ) of float;
   ...
   procedure Get_Thruster_Values(this : in CDispatcher; fDeltaTime : in float; tfValues : out Navigation.Thrusters.TThrusterValuesArray);
   ...
   procedure Set_New_Component_PID_Scalings(this : in CDispatcher; eComponentToChange : Navigation.Motion_Component.EMotionComponent;xNewPIDSCalings : in Navigation.PID_Controller.TPIDComponentScalings);
