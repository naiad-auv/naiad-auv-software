...
package AVR.AT90CAN128.SPI is
   ...
   DDR_SCK 	: Boolean renames AVR.AT90CAN128.DDRB.Bit_1;
   DDR_MISO 	: Boolean renames AVR.AT90CAN128.DDRB.Bit_3;
   DDR_MOSI	: Boolean renames AVR.AT90CAN128.DDRB.Bit_2;
   DDR_SS	: Boolean renames AVR.AT90CAN128.DDRB.Bit_0;
   SS		: Boolean renames AVR.AT90CAN128.PORTB.Bit_0;
