...
package Math.Vectors.CVector_Test_Data is

   type CVector_Access is access all GNATtest_Generated.GNATtest_Standard.Math.Vectors.CVector'Class;
...
end Math.Vectors.CVector_Test_Data;
