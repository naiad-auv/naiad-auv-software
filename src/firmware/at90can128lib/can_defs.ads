...
-- Last changed (yyyy-mm-dd): 2013-10-17 by Nils Brynedal
...
package CAN_Defs is
   ...
   MSG_KILL_SWITCH_ACTIVE		: constant AVR.AT90CAN128.CAN.CAN_Message := (ID => MSG_KILL_SWITCH_ID, Len => 0, Data => (0, others => 0) );
   MSG_KILL_SWITCH_NOT_ACTIVE 		: constant AVR.AT90CAN128.CAN.CAN_Message := (ID => MSG_KILL_SWITCH_ID, Len => 0, Data => (255, others => 0) );
   ...
   MSG_SIMULATION_MODE_ACTIVE		: constant AVR.AT90CAN128.CAN.CAN_Message := (ID => MSG_SIMULATION_MODE_ID, Len => 0, Data => (SIMULATION_MODE_ACTIVE, others => 0) );
   MSG_SIMULATION_MODE_NOT_ACTIVE	: constant AVR.AT90CAN128.CAN.CAN_Message := (ID => MSG_SIMULATION_MODE_ID, Len => 0, Data => (SIMULATION_MODE_NOT_ACTIVE, others => 0) );
