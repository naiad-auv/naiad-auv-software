...
public class DrawingAreaViewModel extends Observable implements IViewModel, Observer {
    ...
    private static Point drawingAreaMoveStartLocation = new Point();
    private static Point drawingAreaMoveEndLocation = new Point();
    ...
    public void WireEvents(Object o) throws IllegalArgumentException {
        ...
        view.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(final MouseEvent eventArgs) {
                ...
                if (SwingUtilities.isLeftMouseButton(eventArgs))
                {
                    isLeftMouseDown = true;
                }
                else if (SwingUtilities.isRightMouseButton (eventArgs))
                {
                ...
                {
                    drawingAreaMoveStartLocation = new Point(eventArgs.getPoint());
                    return;
                }
            ...
            public void mouseReleased(final MouseEvent eventArgs)
            {
                if(isLeftMouseDown && isRightMouseDown)
                {
                    drawingAreaMoveEndLocation = new Point(eventArgs.getPoint());
                    presentationObjective.moveObjects(drawingAreaMoveEndLocation.x - drawingAreaMoveStartLocation.x, drawingAreaMoveEndLocation.y - drawingAreaMoveStartLocation.y);
                }
