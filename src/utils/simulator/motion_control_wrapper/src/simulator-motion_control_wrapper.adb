package body simulator.Motion_Control_Wrapper is
   ...
   function pxCreate_Wrap_Dispatcher return pCWrapDispatcher is
    ...
    begin
      ...
      pxWrapper.pxDispatcher := motioncontrol.Dispatcher.pxCreate;

      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.PositionX,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.PositionY,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.PositionZ,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.RotationX,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.RotationY,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
      pxWrapper.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.RotationZ,
                                                            xNewPIDSCalings    => (0.0,0.0,0.0));
   ...
   procedure Update_Values
     (this : in out CWrapDispatcher;
      ...
      tfMotorValuesTThrustesValuesArray : motioncontrol.Thrusters.TThrusterValuesArray;
   begin
   ...
   begin
      this.pxDispatcher.Set_New_Component_PID_Scalings(eComponentToChange => motioncontrol.Motion_Component.EMotionComponent(eComponentToScale),
                                                       xNewPIDSCalings    => motioncontrol.PID_Controller.TPIDComponentScalings(xComponentScaling));
   ...
   function xGet_Motional_Errors(this : in CWrapDispatcher) return motioncontrol.Dispatcher.TMotionalErrors is
   begin
